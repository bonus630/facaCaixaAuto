...
<xsl:stylesheet version="1.0"
  ...
  <!--uiConfig/commandBars/commandBarData[@guid='c2b44f69-6dec-444e-a37e-5dbf7ff43dae']-->
  <!-- Put the new command at the end of the 'dockers' menu -->
  <!--<xsl:template match="uiConfig/commandBars/commandBarData[@guid='c2b44f69-6dec-444e-a37e-5dbf7ff43dae']">
    <xsl:copy>
      <xsl:apply-templates select="node()|@*"/>
  ...
  <!--<xsl:template match="uiConfig/containers/container[@guid='bee85f91-3ad9-dc8d-48b5-d2a87c8b2109']/container[@guid='Framework_MainFrame-layout']/dockHost/toolbar[@guidRef='c2b44f69-6dec-444e-a37e-5dbf7ff43dae']">-->
