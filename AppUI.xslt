...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:frmwrk="Corel Framework Data">
  ...
  <xsl:template match="uiConfig/items">
    <xsl:copy>
      ...
      <itemData guid="0cc0cc45-ca2b-4211-9ea1-2e6e8cab208e" noBmpOnMenu="true"
                type="checkButton"
                check="*Docker('f3218995-ed44-4643-b433-c24536fe9a8d')"
  ...
  <!--<xsl:template match="uiConfig/containers/container[@guid='bee85f91-3ad9-dc8d-48b5-d2a87c8b2109']/container[@guid='Framework_MainFrame-layout']/dockHost[@guid='894bf987-2ec1-8f83-41d8-68f6797d0db4']">-->
    <xsl:template match="@*|node()">
      <xsl:copy>
        <xsl:apply-templates select="@*|node()"/>
      </xsl:copy>
